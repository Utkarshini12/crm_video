          ...
          <div className="bg-light  min-vh-100">
              ...
              <div className="container">
                 ...
                 <p className="text-success">{message}</p>
                  ...
                  />
                  <input type="submit" className="form-control btn btn-success my-2" value="RAISE TICKET" onClick={()=>setTicketCreationModal(true)} />
                      ...
                      >
                          ...
                          <Modal.Body>
                            <form onSubmit={updateTicket} >
                                <div className="p-1">
                                    <h5 className="card-subtitle mb-2 text-success lead">Ticket ID: {selectedCurrTicket.id}</h5>
                                    <hr />
                                    <div className="input-group ">
